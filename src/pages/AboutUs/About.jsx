...
const About = () => {
  return (
    <div
      className="min-h-screen flex mx-auto "
      style={{
        ...
        <div className="flex justify-around items-center">
          ...
          >
            ...
            <p style={{ fontSize: "14px" }}>
              ...
              changes and addressing the evolving needs of our customers, are
              the key priorities for the development of our Bank.
            </p>
          </div>
        </div>
      </div>
